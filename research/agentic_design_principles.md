...
**Purpose**: Core principles for designing effective multi-agent AI systems
**Audience**: AI agents and engineers designing/operating multi-agent systems
**Version**: 1.0.0
**Derived From**: FORGE development experience and systematic analysis
...
- `agentic_failure_modes.md`: Detailed failure taxonomy and prevention
- `agentic_architecture_patterns.md`: State management and orchestration patterns
- `agentic_handoff_design.md`: Handoff schema templates and validation
- `agentic_human_oversight.md`: Checkpoint design and synthesis patterns
- `agentic_domain_applications.md`: Applying principles to different domains
