...
**Purpose**: Reference for multi-agent system architecture decisions
...
- `agentic_design_principles.md`: Core principles informing architecture choices
- `agentic_failure_modes.md`: Failure modes by architecture type
- `agentic_handoff_design.md`: Inter-agent communication patterns
